...
if (-not ([Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    ...
    $scriptUrl = "https://raw.githubusercontent.com/avm3005/Kloc/main/Setup/KlocV1.0.0.ps1"
...
Write-Host "Installing Kloc Desktop Clock v1.0.0..." -ForegroundColor Cyan
...
# --- 2. DYNAMICALLY GENERATE THE SVG-BASED .ICO NATIVELY ---
Write-Host "Compiling UI Assets & SVG Icon..." -ForegroundColor Green
...
# Native PNG-to-ICO Byte Conversion
...
# --- 3. BUILD THE TASK MANAGER EXECUTABLE (USING NATIVE C# COMPILER) ---
Write-Host "Compiling Native Task Manager Executable..." -ForegroundColor Green
$exeSource = @"
...
# Find native csc.exe compiler path
...
# --- 4. DEFINE THE MAIN CLOCK SCRIPT PAYLOAD ---
$klocContent = @'
...
# --- 5. WRITE REMAINING FILES & START MENU ---
...
'@
Set-Content -Path "$installDir\Restart.vbs" -Value $restartVbs -Encoding Ascii

$startMenuDir = Join-Path ([Environment]::GetFolderPath('Programs')) "Kloc"
...
$shortcutRestart = $WshShell.CreateShortcut((Join-Path $startMenuDir "Restart Kloc.lnk"))
$shortcutRestart.TargetPath = "wscript.exe"
$shortcutRestart.Arguments = "`"C:\Program Files\Detaroxz\Kloc\Restart.vbs`""
$shortcutRestart.IconLocation = "C:\Program Files\Detaroxz\Kloc\icon.ico"
